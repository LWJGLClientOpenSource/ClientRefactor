...
public final class Class918 extends Class916 {
   public Class918(int var1, int var2) {
      super(var1, var2);
   }

   public final void Method14981() {
      if (this.Field3139 != 0) {
         ARBFramebufferObject.glDeleteFramebuffers(this.Field3139);
         this.Field3139 = 0;
      }
   ...
   protected final void Method14982() {
      this.Field3139 = ARBFramebufferObject.glGenFramebuffers();
      ...
      ARBFramebufferObject.glFramebufferTexture2D(36160, 36096, 3553, this.Field3140, 0);
      GL11.glDrawBuffer(0);
      GL11.glReadBuffer(0);
      int var1 = 0;

      for(int var2 = 0; var2 < 5 && (var1 = ARBFramebufferObject.glCheckFramebufferStatus(36160)) != 36053; ++var2) {
         if (var2 == 4) {
            System.err.println("[RenderBufferARB][init]: size: " + this.Field3137 + ", glCheckFramebufferStatus: " + var1);
            Client.Field12069 = false;
            String var3 = "Unable to render " + this.Field3137 + "x" + this.Field3137 + " shadows.";
            Client.Field12059.add(var3);
            System.err.println("[RenderBufferARB]: " + var3);
            this.Method14981();
      ...
      GraphicsDisplay.Method997().Method1035("[RenderBufferARB]: setUpFrameBufferObject(" + this.Field3139 + ", " + this.Field3137 + ", " + var1 + ")");
   }
   ...
   public final void Method14983(boolean var1, int var2, int var3) {
      ...
      if (this.Field3139 != 0 && this.Field3140 != 0) {
         GL11.glClear(256);
         GraphicsDisplay.Method997().Method1035("[RenderBufferARB]: glClear(" + this.Field3139 + ", " + var2 + ")");
         Class745.Method12481(true, true);
         GraphicsDisplay.Method997().Method1035("[RenderBufferARB]: glSetPerspective(" + this.Field3139 + ", " + var2 + ")");
         GL11.glGetFloatv(2983, this.Field3136);
         GL11.glGetFloatv(2982, this.Field3135);
         GraphicsDisplay.Method997().Method1035("[RenderBufferARB]: glGetFloat(" + this.Field3139 + ", " + var2 + ")");
         ARBFramebufferObject.glBindFramebuffer(36160, this.Field3139);
         int var4;
         if ((var4 = ARBFramebufferObject.glCheckFramebufferStatus(36160)) == 36053) {
            GraphicsDisplay.Method997().Method1035("[RenderBufferARB]: glBindFramebuffer(" + this.Field3139 + ", " + var2 + ", " + var4 + ")");
            GL11.glViewport(0, 0, var2, var2);
            GraphicsDisplay.Method997().Method1035("[RenderBufferARB]: glViewport(" + this.Field3139 + ", " + var2 + ")");
            GL11.glPushAttrib(1048575);
            GL11.glCullFace(1029);
            GL11.glEnable(32823);
            GL11.glPolygonOffset(1.5F, 0.0F);
            Class745.Method12475(false);
            GraphicsDisplay.Method997().Method1035("[ShadowMapper]: renderShadowScene(" + var2 + ")");
            ...
            GraphicsDisplay.Method997().Method1035("[RenderBufferARB]: error");
         }
      }
   }
   ...
   public final void Method14984() {
      ...
      if (ARBFramebufferObject.glCheckFramebufferStatus(36160) == 36053) {
         GL11.glClear(256);
         ARBFramebufferObject.glBindFramebuffer(36160, 0);
         GraphicsDisplay.Method997().Method1035("[RenderBufferARB]: unbindFrameBuffer");
      }
   }
}
